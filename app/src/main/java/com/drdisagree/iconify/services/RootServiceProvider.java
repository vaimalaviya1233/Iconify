...
public class RootServiceProvider extends RootService {
    ...
    static class RootServiceImpl extends IRootServiceProvider.Stub {
         ...
         */
        @Override
        public void registerFabricatedOverlay(String overlayName, String targetPackage, List<String> resources) {
            try {
                FabricatedOverlay overlay = FabricatedUtil.getFabricatedOverlay(overlayName, targetPackage, resources.toArray(new String[0]));
